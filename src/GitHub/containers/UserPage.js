...
import loadUser from '../store/action/loadUser'
import loadStarred from '../store/action/loadStarred'
...
class UserPage extends Component {
  ...
  render() {
    ...
    const { renderRepo, handleLoadMoreClick } = this
    return (
      <div>
        <User user={user} />
        <hr />
        <List
          ...
          loadingLabel={`加载 ${login}'s starred...`}
          {...starredPagination}
        />
      </div>
    )
