...
import loadRepo from '../store/action/loadRepo'
import loadStargazers from '../store/action/loadStargazers'
...
class RepoPage extends Component {
  ...
  render() {
    ...
    const { renderUser, handleLoadMoreClick } = this
    return (
      <div>
        ...
        <List
          ...
          loadingLabel={`加载 ${name} 的 stargazers...`}
